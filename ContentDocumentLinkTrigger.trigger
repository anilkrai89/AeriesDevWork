trigger ContentDocumentLinkTrigger on ContentDocumentLink (after insert) {
    ...
    System.debug('Content Document Link Trigger is Enabled: ' + triggerSetting);
    
    if (!triggerSetting.Content_Document_Link_Trigger_Enabled__c) {
        System.debug('Bypassed ContentDocumentLinkTrigger');
        return;
    }
    
    System.debug('ContentDocumentLinkTrigger running');
